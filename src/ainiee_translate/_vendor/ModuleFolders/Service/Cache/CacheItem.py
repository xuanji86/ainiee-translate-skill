...
from ainiee_translate._vendor.ModuleFolders.Service.Cache.BaseCache import ExtraMixin, ThreadSafeCache

# ============================================================
# 条件导入 TiktokenLoader（在文件顶部）
# ============================================================
try:
    from ainiee_translate._vendor.ModuleFolders.Infrastructure.Tokener.TiktokenLoader import get_tiktoken_cache_dir
